        ...
        <tr> 
          <td class="sitetext" valign="middle"> 
            <form name="form1" method="post" action="controller.jsp">
              <table width="52%" border="1" cellspacing="0" cellpadding="5" bordercolor="#336699" background="images/tbg.gif">
                <tr> 
                  <td valign="top"> <b><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif" size="3">Step 
                    1:Modify Form</font><font color="#FFFFFF"> <font color="#168FA9"> 
                    ::</font></font></b> 
                    <table width="100%" border="0" cellspacing="0" cellpadding="5">
                      <tr> 
                        <td bgcolor="#AEC9E3" valign="top"> 
...
%>
                            ...
                            <tr> 
                              ...
                              <td width="60%"> 
                                <input type="hidden" name="activityName" value="modifyform">
                              </td>
                            </tr>
                            <tr align="center"> 
                              <td height="32" width="40%"> 
                                <div align="center"> 
